...
const Friends: React.FC = () => {
  ...
  const { data: searchResults = [], isLoading: isSearching } = useSearchUsers(activeTab === 'add' ? debouncedQuery : '');
          ...
          <TabsContent value="friends" className="mt-0">
            {isLoadingFriendships ? (
              ...
              <EmptyState 
                ...
                description={searchQuery ? "Try a different search term" : "Add friends to start chatting with them"} 
